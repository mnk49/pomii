...
const PomodoroTimer = () => {
  ...
  const handleModeChange = useCallback((newMode: Mode, startImmediately = false) => {
    setMode(newMode);
    ...
    <>
      <Card className="w-full max-w-2xl mx-auto bg-slate-100/80 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/80 dark:border-slate-800/80">
        <CardHeader className="relative">
          ...
          <Tabs value={mode} onValueChange={(value) => handleModeChange(value as Mode)} className="w-full pt-4">
