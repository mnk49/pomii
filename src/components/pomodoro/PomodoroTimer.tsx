...
const PomodoroTimer = () => {
  ...
  return (
    <>
      <Card className="w-full max-w-4xl mx-auto bg-slate-100/80 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/80 dark:border-slate-800/80">
